    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            ...
            <a href="{{ url('/home') }}">
                ...
                <img src="{{ $settings->logo }}" width="180" alt="Logo" style="object-fit: contain;">
                @else
                <img src="{{url('/images/upload_empty/logo_black.png')}}" width="180" alt="Logo" style="object-fit: contain;"/>
                @endif
            </a>
            @elseif(auth()->user()->hasRole('doctor'))
            <a href="{{ url('/doctor_home') }}">
                @if(!isset($settings->logo))
                <img src="{{ $settings->logo }}" width="180" alt="Logo">
                @else
                <img src="{{url('/images/upload_empty/logo_black.png')}}" width="180" alt="Logo"/>
                @endif
            </a>
