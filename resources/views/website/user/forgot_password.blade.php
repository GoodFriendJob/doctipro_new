        ...
        <div class="2xl:w-2/4 xxsm:w-full">
            ...
            <form action="{{ url('/user_forget_password') }}" method="post">
                ...
                <div class="pt-5">
                    ...
                    <input name="email" class="@error('email') is-invalid @enderror w-full text-sm font-fira-sans text-gray block p-2 z-20 border border-white-light" placeholder="Enter email" required type="email">
                    @error('email')
