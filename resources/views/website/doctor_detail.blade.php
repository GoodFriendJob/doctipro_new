        ...
        <div class="flex w-full 2xl:flex-row xl:flex-row xlg:flex-row lg:flex-row xmd:flex-row  md:flex-col sm:flex-col msm:flex-col xsm:flex-col xxsm:flex-col border border-white-light justify-between">
            <div class="flex 2xl:flex-row xl:flex-row xlg:flex-row lg:flex-row xmd:flex-row md:flex-row sm:flex-row msm:flex-row xsm:flex-col xxsm:flex-col">
                ...
                <div class="bg-white-50 2xl:w-96 xl:w-80 xlg:w-72 xl:h-80 xlg:h-80 lg:h-80 lg:w-64 xmd:w-60 xmd:h-72 md:w-full md:h-72 sm:w-full sm:h-72 msm:w-96 msm:h-72 xsm:w-full xsm:h-72 xxsm:w-full xxsm:h-72">
                    <div class="flex flex-col justify-center xmd:mt-5 md:mt-5 lg:mt-10 sm:mt-11 msm:mt-5 xsm:mt-5 xxsm:mt-1 border-l border-white-light h-64">
            ...
            <div class="bg-white-50 2xl:w-full xl:w-full xlg:w-full xl:h-80 xlg:h-80 lg:h-80 lg:w-full xmd:w-full xmd:h-72 md:w-full md:h-72 sm:w-full sm:h-72 msm:w-full msm:h-72 xsm:w-full xsm:h-72 xxsm:w-full xxsm:h-40">
                <div class="flex flex-col items-end">
                    ...
                    <div>
                        ...
                        @else
                        <a href="" class="text-primary"><i class="fa fa-envelope border border-primary 2xl:p-2 xl:p-2 xlg:p-2 lg:p-2 xmd:p-1 xxsm:p-2"></i></a>
                        <a href="" class="text-primary"><i class="fa-solid fa-phone border border-primary 2xl:p-2 xl:p-2 xlg:p-2 lg:p-2 xmd:p-1 xxsm:p-2"></i></a>
                        @endif
                    </div>
            ...
            <div class="lg:w-[30%] xmd:w-[40%] border-b-0 mb-10 border-white-light ml-2">
                <div class="xmd:pl-[10px] pt-6 xxsm:pl-0">
                    ...
                    <h1 class="font-fira-sans leading-5 text-base font-medium text-black">
                        {{__('Today\'s Available Slots')}} - <span class="text-success">{{ $today_day }}</span>
                    </h1>
                    ...
                    <h1 class="font-fira-sans leading-5 text-base font-medium text-black pt-4 mt-2">
                        {{__('Tomorrow’s Available Slots')}} - <span class="text-warning">{{ $tomorrow_day }}</span>
                    </h1>
                    <div class="flex flex-wrap h-48 overflow-hidden	overflow-y-scroll mt-5">
                        <div class="flex flex-wrap">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="flex justify-between pt-5 flex-row">
                                ...
                                <div class="w-36">
                                    ...
                                    @if ($workHour->status)
                                    @php
                                        $start_time = \Carbon\Carbon::parse($period_list->start_time)->format('H\hi');
                                        $end_time = \Carbon\Carbon::parse($period_list->end_time)->format('H\hi');
                                    @endphp
